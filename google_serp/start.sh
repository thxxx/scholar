nohup python3 google_scholar_get_user_list_second.py --keyword1 "MIT" > log_MIT.out 2>&1 &
nohup python3 google_scholar_get_user_list_second.py --keyword1 "Stanford" > log_STANFORD.out 2>&1 &
...
nohup python3 google_scholar_get_user_list.py --keyword1 "kaist" > log_kaist.out 2>&1 &
nohup python3 google_scholar_get_user_list.py --keyword1 "postech" > log_postech.out 2>&1 &
